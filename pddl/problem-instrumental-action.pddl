(define (problem bib-gridworld-problem-instrumental)
  (:domain bib-gridworld)
  (:objects lock1 - lock key1 - key shape1 - shape)
  (:init (= (walls) (new-bit-matrix false 10 10))
         ...
         (= (barriers) (set-index barriers true 5 2))
         (= (barriers) (set-index barriers true 5 3))
         (= (barriers) (set-index barriers true 5 4))
         (= (barriers) (set-index barriers true 5 5))
         (= (barriers) (set-index barriers true 5 6))
         ...
         (= (barriers) (set-index barriers true 6 6))
         (= (walls) (set-index walls true 6 10))
         (= (walls) (set-index walls true 7 1))
         (= (xloc key1) (2))
         (= (yloc key1) (7))
         (= (barriers) (set-index barriers true 7 4))
         (= (barriers) (set-index barriers true 7 5))
         (= (barriers) (set-index barriers true 7 6))
         (= (walls) (set-index walls true 7 9))
         (= (walls) (set-index walls true 7 10))
         (= (walls) (set-index walls true 8 1))
         (= (barriers) (set-index barriers true 8 4))
         ...
         (= (barriers) (set-index barriers true 9 4))
         (locked lock1)
         (= (xloc lock1) (4))
         (= (yloc lock1) (9))
